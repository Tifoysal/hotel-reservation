                        ...
                        <table class="table table-hover table-checkable order-column full-width" id="example4">
                            ...
                            @foreach($rooms as $key=>$room)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <span class="label label-sm @if($room->status==='active') label-success @else label-danger @endif ">{{$room->status}} </span>
                                    </td>
                                    <td class="center">
                                        <a href="{{route('room.edit',$room->id)}}" class="btn btn-tbl-edit btn-xs">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a onclick="return confirm('Are you sure you want to delete this Room?');" href="{{route('room.delete',$room->id)}}" class="btn btn-tbl-delete btn-xs">
