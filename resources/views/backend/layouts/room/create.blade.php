...
@section('content')
                ...
                <form action="{{route('room.store')}}" method="post" role="form">
@csrf
                    <div class="row">
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-6 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input required name="number" class = "mdl-textfield__input" type = "text" id = "txtRoomNo">
                                            <label class = "mdl-textfield__label">Room Number</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input required name="type" class="mdl-textfield__input" type="text" id="list3" value="" readonly tabIndex="-1">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input required name="is_ac" class="mdl-textfield__input" type="text" id="sample2" value="" readonly tabIndex="-1">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input required name="meal" class="mdl-textfield__input" type="text" id="sample3" value="" readonly tabIndex="-1">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input required name="cancellation_rate" class="mdl-textfield__input" type="text" id="sample4" value="" readonly tabIndex="-1">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <input required name="bed_capacity" class="mdl-textfield__input" type="text" id="list2" value="" readonly tabIndex="-1">
                                    ...
                                    <div class="col-lg-6 p-t-20">
                                        <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input required name="rent" class = "mdl-textfield__input" type = "text"
