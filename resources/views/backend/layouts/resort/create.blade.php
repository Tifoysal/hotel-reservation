...
@section('content')
                ...
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Add New Resort</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Add Resort</li>
                        </ol>
                    </div>
                </div>
                <form action="{{route('resort.store')}}" method="post" role="form">
@csrf
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card-box">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input name="mobile" class = "mdl-textfield__input" type = "text"
